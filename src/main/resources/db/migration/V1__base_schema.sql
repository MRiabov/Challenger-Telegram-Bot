...
ALTER TABLE challenge
    ADD CONSTRAINT FK_CHALLENGE_ON_CREATED_BY FOREIGN KEY (created_by) REFERENCES telegram_user (id);

ALTER TABLE challenge
    ADD CONSTRAINT FK_CHALLENGE_ON_GROUP FOREIGN KEY (group_id) REFERENCES groups (id);

ALTER TABLE telegram_user
    ADD CONSTRAINT FK_TELEGRAM_USER_ON_STATS FOREIGN KEY (stats_id) REFERENCES user_stats (id);

ALTER TABLE chat_user
    ADD CONSTRAINT fk_chat_user_on_group FOREIGN KEY (group_id) REFERENCES groups (id);

ALTER TABLE chat_user
    ADD CONSTRAINT fk_chat_user_on_user FOREIGN KEY (user_id) REFERENCES telegram_user (id);

ALTER TABLE challenge_user
    ADD CONSTRAINT fk_chause_on_challenge FOREIGN KEY (challenge_id) REFERENCES challenge (id);

ALTER TABLE challenge_user
    ADD CONSTRAINT fk_chause_on_user FOREIGN KEY (user_id) REFERENCES telegram_user (id);